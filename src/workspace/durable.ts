...
export class DurableQueue{
  ...
  /** The revision the last write was acknowledged at. Callers that record where they saved need the
   *  current number, not the one the queue was built with. */
  at(){return this.revision;}
