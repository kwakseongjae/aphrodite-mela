...
export function agentPanelHtml(d:Delegation,receipts:readonly DelegationReceipt[],language:'en'|'ko',options?:{frameName?:string;channel?:string}):string{
  const ko=language==='ko';
