...
function paletteKey(e:KeyboardEvent){if((e as KeyboardEvent&{isComposing?:boolean}).isComposing&&e.key!=='Enter')return '';return e.key==='ArrowDown'||e.key==='Down'||e.keyCode===40?'ArrowDown':e.key==='ArrowUp'||e.key==='Up'||e.keyCode===38?'ArrowUp':e.key==='Enter'||e.keyCode===13?'Enter':'';}
