...
(function () {
  ...
  var copy = {
    en: {
      ...
      'screens.s1.h': 'Your projects, on this Mac', 'screens.s1.p': 'Home keeps every project as a card with a live preview, grouped into workspaces. Favourites, archive, right-click menus, and one switch that lets an agent edit alongside you. Nothing leaves the machine.',
      ...
      'how.s3.p': 'Approve the direction and export a contract: PROMPT.md, DESIGN.md, tokens.json, the rendered HTML and a project file — everything Codex or Claude Code needs to build exactly what you approved. Or connect them straight to the workbench: one claude mcp add or codex mcp add, and the built-in MCP server hands them the live design — reading always, changing only after you turn it on.',
      ...
      'keeps.eyebrow': 'What it remembers', 'keeps.h2': 'Two files, and both are yours.',
      'keeps.k1.h': 'The archive', 'keeps.k1.p': 'What you looked at, kept: a picture, an address, a line about why it worked. Beside one project or shared across all of them. Promote one and it becomes the reference the analysis runs on.',
      'keeps.k2.h': 'taste.md', 'keeps.k2.p': 'What you keep choosing, written where you can cross it out. Every line carries a count and the ids it came from \u2014 not \u201cyou like serif\u201d, but \u201cserif headings \u2014 6 of 7 projects\u201d. Delete a line and it does not come back.',
      'keeps.k2.note': 'Off by default. Off means nothing is derived, not merely nothing shown.',
      'leaves.eyebrow': 'What leaves this Mac', 'leaves.h2': 'Three connections. That is the whole list.',
      'leaves.l1.when': 'The version check', 'leaves.l1.why': 'On its own, at most every six hours. Can be switched off.',
      'leaves.l2.when': 'Install, in the typeface picker', 'leaves.l2.why': 'The font file you asked for. Enforced in Rust, not by convention.',
      'leaves.l3.when': 'Look it up, on a saved reference', 'leaves.l3.host': 'the address you typed', 'leaves.l3.why': 'Reads that one page for its title and picture.',
      'leaves.close': 'The first happens by itself; the other two only because you pressed something. None of them carries anything about you or your work \u2014 and there is no switch anywhere that would change that.',
    ...
    ko: {
      ...
      'screens.s1.h': '내 Mac 안의 프로젝트', 'screens.s1.p': '홈은 모든 프로젝트를 실시간 미리보기 카드로 보여주고, 작업 공간으로 묶습니다. 즐겨찾기·보관함·우클릭 메뉴, 그리고 에이전트가 함께 편집하게 하는 스위치 하나. 어떤 것도 기기 밖으로 나가지 않습니다.',
      ...
      'how.s3.h': '실제로 만들기',
      'how.s3.p': '방향을 승인하고 계약을 내보내세요. PROMPT.md, DESIGN.md, tokens.json, 렌더된 HTML, 프로젝트 파일까지. Codex나 Claude Code가 승인한 그대로 구현하는 데 필요한 전부입니다. 또는 작업대에 바로 연결하세요. claude mcp add나 codex mcp add 한 줄이면 Aphrodite에 내장된 MCP 서버가 지금의 디자인을 그대로 건네줍니다. 읽기는 늘 되고, 고치는 것은 사람이 켜 줘야 합니다.',
      ...
      'keeps.eyebrow': '무엇을 기억해 두는가', 'keeps.h2': '파일 두 개, 둘 다 당신 것입니다.',
      'keeps.k1.h': '아카이브', 'keeps.k1.p': '당신이 본 것을 모아둡니다 \u2014 사진, 주소, 왜 좋았는지 적은 한 줄. 프로젝트에 붙여두거나 전체가 공유하게 할 수 있습니다. 하나를 올리면 분석이 그것을 레퍼런스로 삼습니다.',
      'keeps.k2.h': 'taste.md', 'keeps.k2.p': '당신이 계속 고르는 것을, 당신이 지울 수 있는 자리에 적어둡니다. 모든 줄이 횟수와 출처 id를 답니다 \u2014 \u201c세리프를 좋아합니다\u201d가 아니라 \u201c세리프 헤딩 \u2014 7개 중 6개 프로젝트\u201d. 줄을 지우면 다시 생기지 않습니다.',
      'keeps.k2.note': '기본값은 꺼짐입니다. 꺼짐은 \u2018안 보여준다\u2019가 아니라 \u2018아무것도 도출하지 않는다\u2019는 뜻입니다.',
      'leaves.eyebrow': '이 Mac을 떠나는 것', 'leaves.h2': '연결은 세 개. 이게 전부입니다.',
      'leaves.l1.when': '버전 확인', 'leaves.l1.why': '스스로, 최대 6시간에 한 번. 꺼둘 수 있습니다.',
      'leaves.l2.when': '서체 선택기의 설치', 'leaves.l2.why': '요청한 폰트 파일. 관례가 아니라 Rust에서 강제합니다.',
      'leaves.l3.when': '저장한 레퍼런스의 가져오기', 'leaves.l3.host': '당신이 입력한 주소', 'leaves.l3.why': '그 페이지 하나에서 제목과 그림만 읽습니다.',
      'leaves.close': '첫 번째는 스스로 일어나고, 나머지 둘은 당신이 눌렀기 때문에만 일어납니다. 어느 것도 당신이나 당신 작업에 관한 것을 싣지 않으며, 그것을 바꿀 스위치는 어디에도 없습니다.',
